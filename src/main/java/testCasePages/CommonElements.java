...
public class CommonElements extends WebHandler {
	...
	public static By AdminLogoutButton = By.xpath("//button[contains(text(),'ログアウト')]");
	...
	public static void Navigate() throws Exception {
		Thread.sleep(2000);
		WebHandler.driver.switchTo().newWindow(WindowType.TAB).get("https://orthodoctor-stage.edulabcbt.com/#/auth/login");
	}
